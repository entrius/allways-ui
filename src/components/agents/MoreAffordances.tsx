...
const mcpJson = `{
  "mcpServers": {
    "allways": {
      "command": "npx",
      "args": ["-y", "@allways/mcp-server@latest"]
    }
  }
}`;
  ...
  <Grid container spacing={{ xs: 2, md: 3 }}>
    <Grid item xs={12} md={6}>
      <AgentCard
        title="MCP server"
        badge="Soon"
        blurb="Drop this into claude_desktop_config.json (or any MCP-aware client) and your agent gets typed Allways tools out of the box."
        code={mcpJson}
      />
    </Grid>
    <Grid item xs={12} md={6}>
