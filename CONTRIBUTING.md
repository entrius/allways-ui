...
For security vulnerabilities, **do not create a public issue**. Report them privately via [GitHub Security Advisories](https://github.com/entrius/allways-ui/security/advisories/new).
...
By contributing to Allways UI, you agree that your contributions will be licensed under the project's license.

---

Thank you for contributing to Allways UI and helping advance open source software development!
